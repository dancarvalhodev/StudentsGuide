		...
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="text-center ">
					<h1>Crie um Guia</h1>
						<input required="required" class="form-control" type="text" maxlength=45 id="myText" placeholder="Digite o Titulo do Guia">
						<select required="required" id="mySelect" class="form-control">
							<option value="sem_tag">Escolha um tipo de inteligência</option>
						...
						<hr>
						<textarea class="form-control" id="cont" rows="3"></textarea>
						<div class="oi"></div>
						<hr>
